...
# user
# from diabetic_package.model_training.LW_segmentation.builders.model_builder import build_model
from diabetic_package.model_training.estimator.LW_segmentation.model.DABNet import DABNet
from diabetic_package.model_training.estimator.LW_segmentation.builders.dataset_builder import build_dataset_train
from diabetic_package.model_training.estimator.LW_segmentation.utils.utils import setup_seed, init_weight, netParams
from diabetic_package.model_training.estimator.LW_segmentation.utils.metric.metric import get_iou
from diabetic_package.model_training.estimator.LW_segmentation.utils.losses.loss import CrossEntropyLoss2d, CrossEntropyLoss2dLabelSmooth
from diabetic_package.model_training.estimator.LW_segmentation.utils.optim import RAdam, Ranger, AdamW
from diabetic_package.model_training.estimator.LW_segmentation.utils.scheduler.lr_scheduler import WarmupPolyLR
# from torch.utils.tensorboard import SummaryWriter
from diabetic_package.model_training.estimator.LW_segmentation.transfer_pth2pt import transfer_pth2pt
...
def parse_args():
    ...
    # model and dataset
    parser.add_argument('--model', type=str, default="DABNet", help="model name: (default ENet)")
    parser.add_argument('--dataset', type=str, default=" ", help="dataset: cityscapes or camvid")
    parser.add_argument('--input_size', type=str, default="512,512", help="input size of model")
...
def train_model(args):
    ...
    for epoch in range(start_epoch, args.max_epochs):
        # training
        lossTr, lr, step = train(args, trainLoader, model, criteria, optimizer, epoch)
