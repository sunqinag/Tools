...
def bz_alexnet(num_classes):
    return BZ_Alexnet(num_classes)

#official resnet50 part
...
class Bottleneck(nn.Module):
    ...
    # convolution(self.conv2)hile original implementation places the stride
...
def resnet18(**kwargs):
    return ResNet_18(BasicBlock_18, [2, 2, 2, 2], **kwargs)
